function FC_BrainEEGLu(ChanPos,AdjWeight,NodeWeight,Param)
    ...
    for i=1:size(EdgeList,1)
        % plot3([N1(i,1) N2(i,1)],[N1(i,2) N2(i,2)],[N1(i,3) N2(i,3)],'color',EdgeColor(i,:),'linewidth',max(2.5,abs(EdgeList(i,3))));
        plot3([N1(i,1) N2(i,1)],[N1(i,2) N2(i,2)],[N1(i,3) N2(i,3)],'color',EdgeColor(i,:),'linewidth',max(0.5,abs(EdgeList(i,3))));
    end

    NodeColor=[0.3 0.3 0.3]; %ChanPos.LobColor(ChanPos.LobID(1,:),:); %MKA
